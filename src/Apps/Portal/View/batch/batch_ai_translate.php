...
$this->layout('project_layout', ['request' => $request, 'title' => '🔤 AI Batch translate']) ?>
...
<form method="post" enctype="multipart/form-data" class="mt-5 row">
    <div class="col mx-auto">
        ...
        <div class="mb-3 form-check">
            <input type="checkbox" class="form-check-input" id="useSameValues" value="1" name="useSameValues" <?=$form['useSameValues'] === true ? 'checked' : ''?>>
            <label class="form-check-label" for="useSameValues">Use same values, that already translated from another records</label>
        </div>

        <div class="mb-3 form-check">
            <input type="checkbox" class="form-check-input" id="includeTranslatedWithoutWarnings" value="1" name="includeTranslatedWithoutWarnings" <?=$form['includeTranslatedWithoutWarnings'] === true ? 'checked' : ''?>>
            <label class="form-check-label" for="includeTranslatedWithoutWarnings">Include translated without warnings</label>
        </div>

        <div class="mb-3 form-check">
            <input type="checkbox" class="form-check-input" id="includeTranslatedWithWarnings" value="1" name="includeTranslatedWithWarnings" <?=$form['includeTranslatedWithWarnings'] === true ? 'checked' : ''?>>
            <label class="form-check-label" for="includeTranslatedWithWarnings">Include translated with warnings</label>
        </div>
